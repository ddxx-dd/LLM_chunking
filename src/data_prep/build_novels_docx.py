...
# 실측 확인된 후보(전체 글자수, 전부 저작 사후 70년 경과로 PD): 탁류(채만식) 420,610자,
# 무정(이광수) 328,291자, 무영탑(현진건) 337,432자, 상록수(심훈) 254,068자,
# 태평천하(채만식) 168,744자, 흙(이광수) 447,000자(CLAUDE.md 기록)
NOVELS = ["상록수", "태평천하", "무영탑", "흙"]
