...
PLOS = [
    ...
    ("pmen.0000700_Human-centred resilience quantification", "10.1371/journal.pmen.0000700", "plosmentalhealth"),
    ("pcsy.0000115_Opinion polarization from compression-based decision making", "10.1371/journal.pcsy.0000115", "ploscomplexsystems"),
]
